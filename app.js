...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='item-list__list_item list-item';
    ...
    deleteButtonImg.className="delete-btn_img";
...
var addTask=function(event){
    ...
    listItem.querySelector(".edit-btn").onclick = editTask;
    taskInput.value="";
...
var editTask=function(){
    ...
    var label=listItem.querySelector(".text-input-label");
